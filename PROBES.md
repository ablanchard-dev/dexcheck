...
- Processes, persistence (Run keys incl. the 32-bit view, scheduled tasks with their arguments, Startup folders resolved to the shortcut target), injection/hijack vectors (AppInit_DLLs, AppCertDLLs, IFEO Debugger), event-log clearing (1102/104, rollover-aware)
